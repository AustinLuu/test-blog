...
const Footer = () => {
    return (
        <footer id ="footer">
            ...
            Designed and <a href="https://github.com/AustinLuu/austinluu.me" rel="noopener noreferrer" target="_blank" style={{fontWeight: "600", textDecoration:"none"}}>developed</a> with <span style={{whiteSpace:"nowrap"}}>☕️ &amp; ❤️ by Austin Luu © 2022.</span> 
            </div>
        </footer>
    )
}
